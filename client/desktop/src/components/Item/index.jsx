...
export default class Item extends React.PureComponent {
    ...
    render() {
        const { poster, title, price, description } = this.props;
        const { count, checked } = this.state;
        const spicy = title.search(/остр/i);

        return (
            <div className="item">
                <input onChange={this.checkedToggle} checked={checked} type="checkbox" className="item-details" aria-hidden/>
                ...
                <BPay onClick={this.onClick} className="item-pay" />
